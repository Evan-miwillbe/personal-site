...
window.SITE_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      name_cn: "可维护个人 Context 系统",
      year: "2026.03 — 2026.06",
      tagline: "把经历变成证据，把证据变成 context",
      activity_meta: "Human-in-the-loop · AI Workflow",
      description_short: "把个人画像、经历证据、项目时间线、录音复盘和 AI 协作记录沉淀进知识库，再用 luying、start-my-day、mineru-pdf、html-to-pptx 等真实使用的 skill 串起来。核心不是让 AI 替我做决定，而是让 AI 先处理噪音、召回材料、发现遗漏。",
      description_full: null,
      tags: ["CONTEXT", "MEMORY", "AI WORKFLOW"],
      tech_stack: ["Obsidian", "luying", "start-my-day", "mineru-pdf", "html-to-pptx"],
      ...
      role_in_loop: null,
      loop_meta: null,
      pricetag: "把经历变成证据，把证据变成 context，把 context 变成更清晰的行动。",
      sort_order: 5
    },
    {
